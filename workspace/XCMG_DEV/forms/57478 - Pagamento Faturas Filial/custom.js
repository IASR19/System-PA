...
let MAIN = {
	...
	displayForm : function() {
		...
		if(CONTEXT.MODE == "VIEW"){
			...
			var aux_aprov_aprovador_financeiro = $("#aux_aprov_aprovador_financeiro").val();
			if (aux_aprov_aprovador_financeiro != ""){
				$("input[name=rd_aprov_aprovador_financeiro][value=" + aux_aprov_aprovador_financeiro + "]").prop('checked', true);
			}
			...
			var aux_aprov_aprovador_financeiro = $("input[name^=aux_aprov_aprovador_financeiro]").val();
			if (aux_aprov_aprovador_financeiro != ""){
				$("input[name^=_rd_aprov_aprovador_financeiro][value=" + aux_aprov_aprovador_financeiro + "]").prop('checked', true);
			}
	...
	, getBudgetFromFluigProcesses : function(branch, costCenter, account) {
		...
		//05/09/2022 - por enquanto nao ira consultar budget
		/*
