function enableFields(form) {
	...
	if(activity == Activity.ABERTURA || activity == Activity.INICIO) {
		...
		fieldsEnabled.push("ds_obs_gerente_area", "aux_aprov_gerente_area");
		disableAllFields(form);
	}else if(activity == Activity.AVALIAR_DIRETOR_AREA){
		fieldsEnabled.push("ds_obs_diretor_area", "aux_aprov_diretor_area");
		disableAllFields(form);
		...
		fieldsEnabled.push("ds_obs_gerente_financeiro", "aux_aprov_gerente_financeiro");
		disableAllFields(form);
