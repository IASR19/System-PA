...
ZOOM.reloadAdvancesZoom = function(){
	...
	let cd_fornecedor = $('#cd_fornecedor').val();
	//let rd_processo = $("input[name=rd_processo]:checked,[name='_rd_processo']:checked").val();
	reloadZoomFilterValues("cd_solicitacao_adiantamento"
		, 'cd_filial,'+cd_filial
			+',cd_centro_custo,'+cd_centro_custo
			//+',rd_processo,'+rd_processo
			);
